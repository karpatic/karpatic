(function() { 
  ...
  callWithJQuery = function(pivotModule) {
    if (typeof exports === "object" && typeof module === "object") { 
      // Common JS
      console.log('pivottablejs')
      return pivotModule(require("jquery"));
    } else { 
      // Neither fallback to using 'jQuery' in the global scope.
      console.log('pivottablejs2')
      console.log(jQuery)
      ...
      try {
        ...
        fn1 = function(attr) {
          ...
          if (values.length > opts.menuLimit) {
            ...
            console.log('not too many values')
            if (values.length > 5) {
        ...
        console.log({returnThis:this, uiTable})
        this.html(uiTable);
        ref2 = opts.cols;
        for (n = 0, len2 = ref2.length; n < len2; n++) {
          x = ref2[n];
        ...
        refresh(); 
        console.log({'thiscon':this, ax: this.find(".pvtAxisContainer")});
